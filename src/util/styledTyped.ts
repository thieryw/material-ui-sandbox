...
function styledTypedMultiple<Props>(
    ...
    const [buildStyleSheet1, buildStyleSheet2, buildStyleSheet3, buildStyleSheet4] = buildStyleSheets;
...
export function styledTyped<Props>(
    ...
    return styledTypedMultiple(component, typeof arg2 === "function" ? [arg2] : arg2);
